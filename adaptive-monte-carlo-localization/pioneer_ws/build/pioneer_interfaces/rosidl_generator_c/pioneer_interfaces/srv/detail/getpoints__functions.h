...
#ifndef PIONEER_INTERFACES__SRV__DETAIL__GETPOINTS__FUNCTIONS_H_
#define PIONEER_INTERFACES__SRV__DETAIL__GETPOINTS__FUNCTIONS_H_
...
#include "pioneer_interfaces/msg/rosidl_generator_c__visibility_control.h"
...
/// Initialize srv/Getpoints message.
/**
 ...
 * )) before or use
 * pioneer_interfaces__srv__Getpoints_Request__create()
...
/// Finalize srv/Getpoints message.
/**
...
/// Create srv/Getpoints message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pioneer_interfaces__srv__Getpoints_Request__init().
...
/// Destroy srv/Getpoints message.
/**
 * It calls
 * pioneer_interfaces__srv__Getpoints_Request__fini()
...
/// Check for srv/Getpoints message equality.
/**
...
/// Initialize array of srv/Getpoints messages.
/**
...
/// Finalize array of srv/Getpoints messages.
/**
 * It calls
 * pioneer_interfaces__srv__Getpoints_Request__fini()
...
/// Create array of srv/Getpoints messages.
/**
...
/// Destroy array of srv/Getpoints messages.
/**
 * It calls
 * pioneer_interfaces__srv__Getpoints_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Getpoints message array equality.
/**
...
/// Copy an array of srv/Getpoints messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * pioneer_interfaces__srv__Getpoints_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_pioneer_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pioneer_interfaces__srv__Getpoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pioneer_interfaces
...
/**
 * It calls
 * pioneer_interfaces__srv__Getpoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pioneer_interfaces
...
/**
 * It calls
 * pioneer_interfaces__srv__Getpoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * pioneer_interfaces__srv__Getpoints_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_pioneer_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pioneer_interfaces__srv__Getpoints_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pioneer_interfaces
...
/**
 * It calls
 * pioneer_interfaces__srv__Getpoints_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pioneer_interfaces
...
/**
 * It allocates the memory for the array and calls
 * pioneer_interfaces__srv__Getpoints_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pioneer_interfaces
...
/**
 * It calls
 * pioneer_interfaces__srv__Getpoints_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PIONEER_INTERFACES__SRV__DETAIL__GETPOINTS__FUNCTIONS_H_
