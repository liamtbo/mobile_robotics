...
multi_agent_search_interfaces__srv__TargetDetected_Request__init(multi_agent_search_interfaces__srv__TargetDetected_Request * msg)
{
  ...
  if (!geometry_msgs__msg__Point__Sequence__init(&msg->targets, 0)) {
    multi_agent_search_interfaces__srv__TargetDetected_Request__fini(msg);
    return false;
  }
  return true;
}
...
multi_agent_search_interfaces__srv__TargetDetected_Request__create(void)
{
  ...
  multi_agent_search_interfaces__srv__TargetDetected_Request * msg = (multi_agent_search_interfaces__srv__TargetDetected_Request *)allocator.allocate(sizeof(multi_agent_search_interfaces__srv__TargetDetected_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(multi_agent_search_interfaces__srv__TargetDetected_Request));
  bool success = multi_agent_search_interfaces__srv__TargetDetected_Request__init(msg);
  if (!success) {
...
multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__init(multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Request * data = NULL;

  if (size) {
    data = (multi_agent_search_interfaces__srv__TargetDetected_Request *)allocator.zero_allocate(size, sizeof(multi_agent_search_interfaces__srv__TargetDetected_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = multi_agent_search_interfaces__srv__TargetDetected_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        multi_agent_search_interfaces__srv__TargetDetected_Request__fini(&data[i - 1]);
      }
...
multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__fini(multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      multi_agent_search_interfaces__srv__TargetDetected_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence * array = (multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence *)allocator.allocate(sizeof(multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__init(array, size);
  if (!success) {
...
multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__destroy(multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__are_equal(const multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence * lhs, const multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!multi_agent_search_interfaces__srv__TargetDetected_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(multi_agent_search_interfaces__srv__TargetDetected_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    multi_agent_search_interfaces__srv__TargetDetected_Request * data =
      (multi_agent_search_interfaces__srv__TargetDetected_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!multi_agent_search_interfaces__srv__TargetDetected_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          multi_agent_search_interfaces__srv__TargetDetected_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!multi_agent_search_interfaces__srv__TargetDetected_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Response * msg = (multi_agent_search_interfaces__srv__TargetDetected_Response *)allocator.allocate(sizeof(multi_agent_search_interfaces__srv__TargetDetected_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(multi_agent_search_interfaces__srv__TargetDetected_Response));
  bool success = multi_agent_search_interfaces__srv__TargetDetected_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
multi_agent_search_interfaces__srv__TargetDetected_Response__destroy(multi_agent_search_interfaces__srv__TargetDetected_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    multi_agent_search_interfaces__srv__TargetDetected_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__init(multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Response * data = NULL;

  if (size) {
    data = (multi_agent_search_interfaces__srv__TargetDetected_Response *)allocator.zero_allocate(size, sizeof(multi_agent_search_interfaces__srv__TargetDetected_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = multi_agent_search_interfaces__srv__TargetDetected_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        multi_agent_search_interfaces__srv__TargetDetected_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__fini(multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      multi_agent_search_interfaces__srv__TargetDetected_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence * array = (multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence *)allocator.allocate(sizeof(multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__destroy(multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__are_equal(const multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence * lhs, const multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!multi_agent_search_interfaces__srv__TargetDetected_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(multi_agent_search_interfaces__srv__TargetDetected_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    multi_agent_search_interfaces__srv__TargetDetected_Response * data =
      (multi_agent_search_interfaces__srv__TargetDetected_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!multi_agent_search_interfaces__srv__TargetDetected_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          multi_agent_search_interfaces__srv__TargetDetected_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!multi_agent_search_interfaces__srv__TargetDetected_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
multi_agent_search_interfaces__srv__TargetDetected_Event__init(multi_agent_search_interfaces__srv__TargetDetected_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    multi_agent_search_interfaces__srv__TargetDetected_Event__fini(msg);
    return false;
  }
  // request
  if (!multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__init(&msg->request, 0)) {
    multi_agent_search_interfaces__srv__TargetDetected_Event__fini(msg);
    return false;
  }
  // response
  if (!multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__init(&msg->response, 0)) {
    multi_agent_search_interfaces__srv__TargetDetected_Event__fini(msg);
    return false;
  }
  return true;
...
multi_agent_search_interfaces__srv__TargetDetected_Event__fini(multi_agent_search_interfaces__srv__TargetDetected_Event * msg)
{
  ...
  // request
  multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__fini(&msg->request);
  // response
  multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__fini(&msg->response);
}
...
multi_agent_search_interfaces__srv__TargetDetected_Event__are_equal(const multi_agent_search_interfaces__srv__TargetDetected_Event * lhs, const multi_agent_search_interfaces__srv__TargetDetected_Event * rhs)
{
  ...
  // request
  if (!multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__are_equal(
  ...
  multi_agent_search_interfaces__srv__TargetDetected_Event * output)
{
  ...
  // request
  if (!multi_agent_search_interfaces__srv__TargetDetected_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!multi_agent_search_interfaces__srv__TargetDetected_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Event * msg = (multi_agent_search_interfaces__srv__TargetDetected_Event *)allocator.allocate(sizeof(multi_agent_search_interfaces__srv__TargetDetected_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(multi_agent_search_interfaces__srv__TargetDetected_Event));
  bool success = multi_agent_search_interfaces__srv__TargetDetected_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence__init(multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Event * data = NULL;

  if (size) {
    data = (multi_agent_search_interfaces__srv__TargetDetected_Event *)allocator.zero_allocate(size, sizeof(multi_agent_search_interfaces__srv__TargetDetected_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = multi_agent_search_interfaces__srv__TargetDetected_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        multi_agent_search_interfaces__srv__TargetDetected_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence__fini(multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      multi_agent_search_interfaces__srv__TargetDetected_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence * array = (multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence *)allocator.allocate(sizeof(multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence__destroy(multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence__are_equal(const multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence * lhs, const multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!multi_agent_search_interfaces__srv__TargetDetected_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  multi_agent_search_interfaces__srv__TargetDetected_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(multi_agent_search_interfaces__srv__TargetDetected_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    multi_agent_search_interfaces__srv__TargetDetected_Event * data =
      (multi_agent_search_interfaces__srv__TargetDetected_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!multi_agent_search_interfaces__srv__TargetDetected_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          multi_agent_search_interfaces__srv__TargetDetected_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!multi_agent_search_interfaces__srv__TargetDetected_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
