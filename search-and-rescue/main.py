...
def generate(
    ...
    if has_robots or has_extra_points:
        ...
        centered_robot_positions: Optional[list[tuple[float, float]]] = None
        ...
        centered_extra_points: Optional[list[tuple[float, float]]] = None
    ...
    if resolved_debug:
        ...
        robot_positions_for_debug: Optional[list[tuple[float, float]]] = None
        extra_positions_for_debug: Optional[list[tuple[float, float]]] = None
        if has_robots:
